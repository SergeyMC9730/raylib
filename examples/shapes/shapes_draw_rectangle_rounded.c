...
int main(void)
{
    ...
    while (!WindowShouldClose())    // Detect window close button or ESC key
    {
        ...
        BeginDrawing();
            ...
            //------------------------------------------------------------------------------
<<<<<<< HEAD
            GuiSliderBar((RLRectangle){ 640, 40, 105, 20 }, "Width", NULL, &width, 0, (float)GetScreenWidth() - 300);
            GuiSliderBar((RLRectangle){ 640, 70, 105, 20 }, "Height", NULL, &height, 0, (float)GetScreenHeight() - 50);
            GuiSliderBar((RLRectangle){ 640, 140, 105, 20 }, "Roundness", NULL, &roundness, 0.0f, 1.0f);
            GuiSliderBar((RLRectangle){ 640, 170, 105, 20 }, "Thickness", NULL, &lineThick, 0, 20);
            GuiSliderBar((RLRectangle){ 640, 240, 105, 20}, "Segments", NULL, &segments, 0, 60);
=======
