...
RMAPI Matrix MatrixFrustum(double left, double right, double bottom, double top, double rnear, double rfar)
{
    Matrix result = { 0 };
    ...
    result.m12 = 0.0f;
    result.m13 = 0.0f;
    result.m14 = -((float)rfar*(float)rnear*2.0f)/fn;
    result.m15 = 0.0f;
