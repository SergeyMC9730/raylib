...
void RlDrawTextEx(RLFont font, const char *text, Vector2 position, float fontSize, float spacing, Color tint)
{
...
// NOTE: If codepoint is not found in the font it fallbacks to '?'
RLRectangle GetGlyphAtlasRec(RLFont font, int codepoint)
{
    RLRectangle rec = { 0 };
