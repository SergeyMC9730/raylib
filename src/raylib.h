...
RLAPI void DrawRectangleGradientEx(RLRectangle rec, Color topLeft, Color bottomLeft, Color bottomRight, Color topRight); // Draw a gradient-filled rectangle with custom vertex colors
...
RLAPI RLFont GetFontDefault(void);                                                            // Get the default Font
...
RLAPI void RlDrawTextEx(RLFont font, const char *text, Vector2 position, float fontSize, float spacing, Color tint); // Draw text using font and additional parameters
